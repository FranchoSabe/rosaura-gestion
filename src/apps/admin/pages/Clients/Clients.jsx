          ...
          {filteredAndSortedClients.map((client) => (
            ...
            >
              <div className={styles.mobileCardHeader}>
                ...
                <span className={`${styles.mobileCardStatus} ${client.listaNegra ? 'blacklisted' : 'normal'}`}>
                  {client.listaNegra ? 'Lista negra' : 'Normal'}
                </span>
              </div>

              <div className={styles.mobileCardStats}>
                <div className={styles.mobileCardStat}>
                  <span className={`${styles.mobileCardStatValue} past`}>{client.reservasPasadas}</span>
                  <span className={styles.mobileCardStatLabel}>Pasadas</span>
                </div>
                <div className={styles.mobileCardStat}>
                  <span className={`${styles.mobileCardStatValue} future`}>{client.reservasFuturas}</span>
                  <span className={styles.mobileCardStatLabel}>Futuras</span>
                </div>
              </div>

              <div className={styles.mobileCardLastReservation}>
                Última: {getLastReservationDate(client)}
              </div>

              <div className={`${styles.mobileCardNotes} ${!client.notasInternas ? 'empty' : ''}`}>
                {client.notasInternas || 'Sin notas'}
              </div>
              ...
              <div className={styles.mobileCardActions}>
                <button
                  ...
                  className={`${styles.mobileCardActionButton} edit`}
                  title="Editar notas"
                >
                  <Edit2 size={12} />
                  Notas
                ...
                <button
                  ...
                  className={`${styles.mobileCardActionButton} ${client.listaNegra ? 'remove' : 'blacklist'}`}
                  title={client.listaNegra ? 'Quitar de lista negra' : 'Agregar a lista negra'}
                >
                  {client.listaNegra ? 'Quitar' : 'Bloquear'}
                </button>
